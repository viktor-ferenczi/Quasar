...
| `clearAssetFolderCaches()` / `clearContentFolderCaches()` | Clears resolved path, miss, in-flight lookup, lowercase directory-entry, metadata, texture, and archive caches. |

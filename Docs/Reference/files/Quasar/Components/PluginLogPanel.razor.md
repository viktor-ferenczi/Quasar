...
**Log table (`MudTable`):** Fixed header, 420 px height, sortable columns for Time (UTC), Level, Server, Plugin; Message column includes optional exception text in `Color.Error`.

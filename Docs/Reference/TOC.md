...
This handbook covers **196 source files** across **11 modules**. Browse by module below, or jump to the flat [file Index](Index.md).
...
| [Quasar.Agent](Modules/Quasar.Agent.md) | 11 | In-DS plugin: telemetry, command execution, supervisor attach. |

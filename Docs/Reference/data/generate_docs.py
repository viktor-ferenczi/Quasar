...
toc.append("*This handbook was generated by the `structured-documentation` skill. "
           ...
           "and the regeneration scripts and cache data under `data/`. "
           "Re-run `data/build_manifest.py`, `data/make_groups.py` (for new files), "
           "`data/build_graph.py`, then `data/generate_docs.py` to refresh.*")

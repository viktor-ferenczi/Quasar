...
| `updateLighting()` | Applies the lighting toggle state to ambient/environment fill, the directional sun, grid light group, and sun marker helpers. |
